      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/NNSS3",
                   'caption'=>'𝗧𝗛𝗘 𝗣𝗥𝗢𝗚𝗥𝗔𝗠𝗠𝗜𝗡𝗚 𝗪𝗔𝗦 𝗗𝗢𝗡𝗘 𝗕𝗬 : @NNSS3',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'تسجيل دخول','callback_data'=>'login']],
                       [['text'=>"مطور البوت 🌚", 'url'=>"https://t.me/NNSS3"]],
                      ]
                  ])
              ]);   
          } 
if($text == '/help'){
              ...
              'video'=>"https://t.me/NNSS3",
              'caption'=>'طرق السحبب🤘😂',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"𝙍𝙚𝙥𝙤𝙧𝙩 𝙋𝙧𝙤𝙗𝙡𝙚𝙢𝙨", 'url'=>"https://t.me/NNSS3"]],
                       ]
                       ])
                       ]);
    
              $bot->sendvoice([ 'chat_id'=>$chatId,
                  'voice'=>"https://t.me/NNSS3",
          	...
          	if($config['mode'] != null){
          		...
          		if($mode == 'addL'){
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                      'text'=>"𝗧𝗛𝗘 𝗣𝗥𝗢𝗚𝗥𝗔𝗠𝗠𝗜𝗡𝗚 𝗪𝗔𝗦 𝗗𝗢𝗡𝗘 𝗕𝗬 : @NNSS3",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
            ...
            $bot->editMessageText([
                ...
                'reply_markup'=>json_encode([
                    'inline_keyboard'=>[
                        ...
                        [['text'=>'من هاشتاك ','callback_data'=>'hashtag'],['text'=>'من الاكسبلور','callback_data'=>'explore']],
